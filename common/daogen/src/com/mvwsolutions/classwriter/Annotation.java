...
public class Annotation implements AnnotationInfo {
	...
	/* (non-Javadoc)
	 * @see com.mvwsolutions.classwriter.AnnotationInfo#gatherAnnotationInfo(com.mvwsolutions.classwriter.ClassWriter, java.util.Collection, java.util.Collection)
	 */
	...
	public static class EnumValue extends ValueBase
	{
		...
		/* (non-Javadoc)
		 * @see com.mvwsolutions.classwriter.Annotation.ValueBase#write(java.io.DataOutputStream)
		 */
		@Override
		void write(DataOutputStream classStream) throws IOException {
		...
		public void gatherAnnotationInfo(ClassWriter container, Collection<Annotation> annotations, Collection<String> strings) {
			String s = container.getString(enumName);
			if (s != null) {
				strings.add(s);
			}
		}
	...
	public static class AnnotationValue extends ValueBase
	{
		...
		/* (non-Javadoc)
		 * @see com.mvwsolutions.classwriter.Annotation.ValueBase#gatherAnnotationInfo(com.mvwsolutions.classwriter.ClassWriter, java.util.Collection, java.util.Collection)
		 */
		@Override
		public void gatherAnnotationInfo(ClassWriter container, Collection<Annotation> annotations, Collection<String> strings) {
