...
class TableDefinition {
	...
	void generateClassDefinition(PrintWriter pw)
		...
		id.nl();
		id.ivprintln( MessageFormat.format( "{1} class {0} extends com.antlersoft.android.dbimpl.{2}ImplementationBase<{3}> '{'",
...
//		}
		...
		id.nl();
		id.iprintln(MessageFormat.format("public String getPkColumnName() '{' return \"{0}\"; }", pkFieldDef.columnName));
